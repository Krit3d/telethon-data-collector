...
def upgrade() -> None:
    ...
    op.add_column('accounts', sa.Column('static_sentiment', sa.String(50), nullable=True, comment="Pre-calculated prevailing sentiment of the author's recent posts. Avoids heavy runtime aggregations during search"))
...
def downgrade() -> None:
    ...
    op.drop_column('accounts', 'static_sentiment')
